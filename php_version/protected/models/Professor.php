...
class Professor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_professor, nome, aprovado, foto', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'depoimentos' => array(self::HAS_MANY, 'Depoimento', 'id_professor'),
			'disciplinas' => array(self::MANY_MANY, 'Disciplina', 'professor_disciplina(professor_id_professor, disciplina_id_disciplina)'),
			'votos' => array(self::HAS_MANY, 'Voto', 'id_professor'),
		);
	}
